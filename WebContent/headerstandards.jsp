...
<div id="top">
            ...
            <div class="leftside" id="leftmenu">
         		<ul class="form">
		<li><a class="messages" href="StandardController?action=liststandards"><i class="icon-envelope-alt"></i>List of Standards</a></li>
		<li><a class="settings" href="searchstandards.jsp"><i class="icon-cog"></i>Search Standards</a></li>
