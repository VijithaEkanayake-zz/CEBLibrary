	...
	$.supersized({
		...
		slides 					:	[			// Slideshow Images
			{image : './images/slider/image1.jpg',
				title : '<h2><span>Today a reader.</span> Tomorrow a leader.</h2>',
				thumb : '',
				url : ''
				},

			{image : './images/slider/image2.jpg',
				title : '<h2><span>Books are a</span> uniquely portable magic.</h2>',
				thumb : '',
				url : ''
				},

			{image : './images/slider/image3.jpg',
				title : '<h2><span>Reading is deaming</span> in open eyes.</h2>',
				thumb : '',
				url : ''
				},

			{image : './images/slider/image4.jpg',
				title : '<h2><span>When in doubt</span> visit your library.</h2>',
				thumb : '',
				url : ''
				},

			{image : './images/slider/image5.jpg',
				title : '<h2><span>Your Library is</span> your paradise.</h2>',
				thumb : '',
				url : ''
				}
		],
