     ...
     <div id="features" class="page section">
        ...
        <div class="container featuresContainer">
        	<div class="sixteen columns">
				...
				<img alt="High Voltage" src="img/new1.jpeg"  width="250" height="350" style="padding: 5px;"/>
				<img alt="Applid Human resource" src="img/new2.jpeg" width="250" height="350" style="padding: 5px;" />
         ...
         <div id="parallax-4" class="parallax fixed" style="background-image: url(images/parallax-4.jpg);">
             <div class="quoteWrap">
				<div class="quote">
                	<div class="container">
                        <div class="sixteen columns">
                            <h3><span class="largeBold">A Reader Lives</span> <span class="large">a thousand</span>
                                <br><span class="medium">lives before</span> <span class="mediumBold">he dies.</span>
                                <br><span class="large">The man who never read </span> <span class="largeBold">Lives only one.</span> 
                                <br><span class="author">George R.R. Martin</span>
                            </h3>
                        </div>
                    </div>  
				</div>
		...
		<div class="sixteen columns">
			...
			<div class="three columns marginTop contactDetails">
				<p class="contactAddress">
					Ceylon Electricity Board Library<br />P.O. Box. 540,  <br /> Ceylon Electricity Board, <br />5th Floor, Sir Chittampalam A Gardiner Mawatha, <br />Colombo 02 <br /> SRI LANKA .<br /><a
						href="#?custom=true&width=500&height=500" rel="prettyPhoto">Google
						Map</a></p>
			</div>
			<div class="three columns marginTop contactDetails">
				<p class="contactPhone">Phone: +94 -11- 2382647<br />Staff Members:
Please use the Intercom Extensions to contact Library staff</p>
				<p class="contactPhone">Fax: +94-11-2325360<br />Intercom Extension: 219</p>
			...
			<div class="three columns marginTop contactDetails">
				<p class="contactTime">
					Mon-Fri: 8:30am &rarr; 4:30pm <br /> The Library will be closed on week-ends  & all public holidays including Poya Days.
				</p>
			</div>
			...
			<div class="quoteWrap">
				<div class="quote">
					<div class="container">
						<div class="sixteen columns">
							<h3>
								<span class="large">Books are </span> <span class="largeBold">uniquely </span> <br> <span class="medium">Portable</span><span
									class="mediumBold"> magic.</span>
									<br><span class="author">Stephen King</span>
							</h3>
						</div>
					</div>
				</div>
